...
export async function generateMetadata() {
  ...
  const title = 'Obra / reforma / instalación | NERIN'
  const description = 'Formulario para trabajos de obra, reforma e instalación con definición técnica.'
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:gap-12">
      <div className="space-y-6 sm:space-y-8">
        <Badge>Obra / reforma / instalación</Badge>
        <h1>Contanos el trabajo</h1>
        <p className="max-w-2xl text-lg text-slate-600">Completá el formulario y te armamos una propuesta clara.</p>
      ...
      <aside className="space-y-5 rounded-3xl border border-border bg-white p-5 shadow-subtle sm:p-7 lg:sticky lg:top-24">
        ...
        <ul className="space-y-3 text-sm text-slate-600">
          <li>• Revisión del alcance real del trabajo.</li>
          <li>• Definición técnica y forma de ejecución.</li>
          <li>• Propuesta con tiempos y próximos pasos.</li>
        </ul>
